                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="">Meter Awal</label>
                                        <input type="text" name="meter_awal" id="meter_awal" class="form-control form-control-user" id="meter_awal" value="<?= set_value('meter_awal'); ?>">
                                        <?= form_error('meter_awal', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="">Meter Akhir</label>
                                    <input type="text" name="meter_akhir" id="meter_akhir" class="form-control form-control-user" id="meter_akhir"
